...
<body style="background-image: url(image.jpg); height: inherit">
    <div>
        ...
        <div style="min-height: 520px; ">
            <h2 class="text-decoration-underline text-white text-center" style="font-family: montserrat;">HOME APPLIANCES PRODUCTS</h2>
            ...
            <center>
                <table class="table table-responsive border table-striped text-center">
                    ...
                    <%
                        ...
                        ResultSet rs = st.executeQuery("Select * from `products` where CAT_ID = (select C_ID from categories where C_NAME = 'HOME APPLIANCES')");
                        int temp;
                        temp = 0;
                        while(rs.next())
                        { temp++;
