            ...
            <div style="min-height: fit-content; padding-bottom: 10px">
                ...
                <%
                            ...
                            if(temp<1){
                                ...
                                <center><h4 class="text-light d-inline-block text-center">Item is Added In Your Cart, &nbsp;&nbsp;&nbsp;<b><a href="listProduct_User.jsp" class="link-danger d-inline-block">Add Items.</a></b></h4></center>
                                <hr class="w-75 text-light">
                                <%
                            }
                            else {
